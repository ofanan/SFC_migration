...
class Res_file_parser (object):  
    ...
    def parse_file (self, input_file_name):
        ...
        for line in lines:
            ...
            # if (not(self.dict in self.set_of_dicts)): # verify that such an item doesn't already exist in the list. However, if using set_of_dicts, no need for this check 
            self.set_of_dicts.ad(self.dict)
    ...
    def gen_filtered_list (self, list_to_filter, alg_mode = None, alg_mode = None):
        """
