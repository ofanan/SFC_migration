...
class SFC_mig_simulator (object):
    ...
    print_sol_to_res = lambda self : printf (self.res_output_file, 't{}.{} | cost = {:.2f} | rsrc_aug = {:.2f}\n' .format(self.t, self.alg, self.calc_sol_cost(), self.calc_rsrc_aug())) 
...
if __name__ == "__main__":
    ...
    my_simulator.simulate ('worst_fit')
