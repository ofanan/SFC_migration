...
if __name__ == "__main__":
    ...
    my_simulator = SFC_mig_simulator (poa2cell_file_name='Lux.post.antloc_256cells.poa2cell', poa_file_name='Monaco_0820_0830_1secs_Telecom.poa', verbose=[VERBOSE_RES])
    
    for sd in range (1, 21): 
        my_simulator.simulate (mode = 'ourAlg', cpu_cap_at_leaf=209, seed=sd)
