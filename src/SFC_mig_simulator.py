...
class SFC_mig_simulator (object):
    ...
    gen_RT_prob_sim_output_file = lambda self, poa2cell_file_name, poa_file_name, mode : open ('../res/RT_prob_sim_{}_{}_{}.res_1' .format (poa2cell_file_name, poa_file_name, mode), 'a')    
