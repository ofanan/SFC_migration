...
class loc2ap_c (object):
    ...
    def parse_files (self, loc_file_names):
        ...
        """
        if (VERBOSE_AP in self.verbose):
            self.ap_file        = open ("../res/" + loc_file_names[0].split('.')[0] + '.' + str(self.num_of_APs) + 'aps' +".ap", "w+")  
...
if __name__ == '__main__': 
    ...
    my_loc2ap.parse_files (['0829_0830_1secs.loc']) #(['0730.loc', '0740.loc', '0750.loc', '0800.loc', '0810.loc', '0820.loc'])
